...
table_dirs = [
    "dwd_customer_service_promo_activity",
    "dwd_customer_service_promo_activity_item",
    "dwd_customer_service_promo_send",
    "dwd_customer_service_promo_use"
]
