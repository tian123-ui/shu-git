...
table_dirs = [
    "dws_customer_service_promo_activity",
    "dws_customer_service_promo_cs",
    "dws_customer_service_promo_daily",
    "dws_customer_service_promo_product"
]
